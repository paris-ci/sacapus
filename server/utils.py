...
def init_logger():
    ...
    base_logger = logging.getLogger("sacapus")
    ...
    file_handler = RotatingFileHandler('sacapus_all.log', 'a', 10000000, 10)
    file_handler.setFormatter(formatter)
    file_handler.setLevel(logging.DEBUG)
    base_logger.addHandler(file_handler)

    file_handler = RotatingFileHandler('sacapus_errors.log', 'a', 1000000, 10)
    file_handler.setFormatter(formatter)
